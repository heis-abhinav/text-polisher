  ...
  return (
    ...
    <div className='container' style = {{color: props.mode ==='dark'? 'white': 'black'}}>
        ...
        <div className="mb-3">
            ...
            <button className="btn btn-primary mx-2 my-2" onClick = {()=> handleUpClick()}>Convert UpperCase Text</button>
            <button className="btn btn-primary mx-2 my-2" onClick = {()=> handleLowerClick()}>Convert LowerCase Text</button>
        </div>
    </div>
